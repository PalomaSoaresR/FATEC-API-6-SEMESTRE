...
class TestTaskCalculatePtPnt:
    ...
    @patch('backend.tasks.task_calculate_pt_pnt.get_mongo_sync_db')
    def test_reagenda_quando_job_nao_concluido(self, mock_db):
    ...
    @patch('backend.tasks.task_calculate_pt_pnt.get_mongo_sync_db')
    def test_reagenda_quando_job_nao_existe(self, mock_db):
        from celery.exceptions import Retry
    ...
    @patch('backend.tasks.task_calculate_pt_pnt.calculate_pt_pnt')
    @patch('backend.tasks.task_calculate_pt_pnt.get_mongo_sync_db')
    def test_retorna_zero_conjuntos(self, mock_db, mock_calculate):
